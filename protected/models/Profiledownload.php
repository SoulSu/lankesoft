...
class Profiledownload extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            array('describe, content, attach, thumbnail, publish_time, ctime', 'required'),
            array('cate_id, sort, downloadnums, publish_time, mtime, ctime', 'numerical', 'integerOnly' => true),
            array('title, filesize, fileproperty, thumbnail', 'length', 'max' => 128),
            array('attach', 'length', 'max' => 255),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, title, cate_id, sort, filesize, fileproperty, describe, content, attach, thumbnail, downloadnums, publish_time, mtime, ctime', 'safe', 'on' => 'search'),
        );
    }
